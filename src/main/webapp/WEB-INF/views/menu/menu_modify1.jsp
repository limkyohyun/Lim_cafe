     ...
     <c:forEach items="${list}" var="my">
      <div class="col-md-3" style="padding:15px; width: 330px; height: 50%;">
        <div class="card">
         ...
         <a href="menu_detail2?menuname=${my.menuname}"> <img src="/lim/image/${my.poster}" class="card-img-top" data-title="${my.menuname}" ></a>
     ...
     <c:forEach items="${list2}" var="coffee">
      <div class="col-md-3" style="padding:15px; width: 330px; height: 50%;">
        <div class="card">
         ...
         <a href="menu_detail2?menuname=${coffee.menuname}"> <img src="/lim/image/${coffee.poster}" class="card-img-top" data-title="${coffee.menuname}" ></a>
     ...
     <c:forEach items="${list3}" var="drin">
      <div class="col-md-3" style="padding:15px; width: 330px; height: 50%;">
        <div class="card">
         ...
         <a href="menu_detail2?menuname=${drin.menuname}"> <img src="/lim/image/${drin.poster}" class="card-img-top" data-title="${drin.menuname}"></a>
     ...
     <c:forEach items="${list4}" var="dessert">
      <div class="col-md-3" style="padding:15px; width: 330px; height: 50%;">
        <div class="card" >
         ...
         <a href="menu_detail2?menuname=${dessert.menuname}"> <img src="/lim/image/${dessert.poster}" class="card-img-top" data-title="${dessert.menuname}" ></a>
        ...
        <div id="content5" class="tab-content green">
  <div class="row">
     <c:forEach items="${list5}" var="all">
      <div class="col-md-3" style="padding:15px;">
        <div class="card" >
         
         <a href="menu_detail2?menuname=${all.menuname}"> <img src="/lim/image/${all.poster}" class="card-img-top" data-title="${all.menuname}" ></a>
          
          <div class="card-body">
            <h5 class="card-title">${all.menuname}</h5>
          </div>
        </div>
      </div>
    </c:forEach>
